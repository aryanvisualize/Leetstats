document.addEventListener("DOMContentLoaded", function(){
    ...
    //return true/false based on a regular expression
    ...
    function displayUserData(parsedData){
        ...
        const cardsData = [
            { label: "Overall Submissions", value: parsedData.data.matchedUser.submitStatsGlobal.acSubmissionNum[0].submissions },
            { label: "Overall Easy Submissions", value: parsedData.data.matchedUser.submitStatsGlobal.acSubmissionNum[1].submissions },
            { label: "Overall Medium Submissions", value: parsedData.data.matchedUser.submitStatsGlobal.acSubmissionNum[2].submissions },
            { label: "Overall Hard Submissions", value: parsedData.data.matchedUser.submitStatsGlobal.acSubmissionNum[3].submissions },
        ];
    ...
    searchButton.addEventListener('click', function(){
        ...
        console.log("Logging u in ", username);
